 ...
 *
 * Writes a task specification to `.overstory/specs/<task-id>.md` for delivery
 * workflows, or `.trellis/specs/<task-id>.yaml` for co-creation workflows.
...
/**
 * Write a spec file. Routes to .overstory/specs/<task-id>.md (delivery)
 * or .trellis/specs/<task-id>.yaml (co-creation / --trellis).
 *
